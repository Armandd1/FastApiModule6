Frontend git repo: https://github.com/Armandd1/FastApi6Frontend
...
1. **Create the database connection (`database.py`):**
...
1. **Create utility functions (`utils.py`):**
...
1. **Create Database model for users (`models/user.py`):**
...
1. **Create Pydantic models for user registration (`models/user.py`):**
...
1. **Create route for user registration (`routers/users.py`):**
